...
<body>
  ...
  <button id="memberaccept">확인</button> 
  <button id="deldte">회원탈퇴</button>
</div> 

<script type="text/javascript">
document.getElementById("memberaccept").addEventListener("click", function(){
...
document.getElementById("deldte").addEventListener("click", function(){
	var id = document.getElementById("id").value;
	document.location.href = "MemberDelete?id="+id;
});
</script>
</body>
